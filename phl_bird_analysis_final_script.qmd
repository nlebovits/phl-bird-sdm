...
unique = tm_shape(phl_ebird_hex_means) + 
                  tm_polygons(title = "Avg. Unique Species",
                  ...
                  tm_layout(title = "Avg. Unique Species per Year")+
...
vu_unique = tm_shape(vu_phl_ebird_hex_means) + 
                  tm_polygons(title = "Avg. Unique Species",
                              ...
                              id = "hex_id",
                              popup.vars = c("Avg. Unique Species" = "avg_unique_species")) +
                  tm_layout(title = "Avg. Unique Vulnerable Species per Year") +
                  tm_view(view.legend.position = c("right", "bottom"),
            colorNA = 'transparent')
...
zero_ft = tm_shape((piv_long_SLR |> filter (pct_SLR_ == "0ft"))) +
  tm_polygons(
    ...
    tm_layout(title = "Current Sea Level Rise")+
  tm_view(view.legend.position = c("right", "bottom"),
            colorNA = 'transparent')
  
one_ft = tm_shape((piv_long_SLR |> filter (pct_SLR_ == "1ft"))) +
  tm_polygons(
              title = "Pct. Inundation",
              col = 'value', 
              palette = 'viridis', 
              ...
              id = "hex_id",
              popup.vars = c("Pct. Inundation" = "pct_SLR_")) +
    tm_layout(title = "1 Foot Sea Level Rise")+
  tm_view(view.legend.position = c("right", "bottom",
            colorNA = 'transparent'))
  
two_ft = tm_shape((piv_long_SLR |> filter (pct_SLR_ == "2ft"))) +
  tm_polygons(
              title = "Pct. Inundation",
              col = 'value', 
              palette = 'viridis', 
              ...
              id = "hex_id",
              popup.vars = c("Pct. Inundation" = "pct_SLR_")) +
    tm_layout(title = "Two Feet Sea Level Rise")+
  tm_view(view.legend.position = c("right", "bottom"),
            colorNA = 'transparent')
  
three_ft = tm_shape((piv_long_SLR |> filter (pct_SLR_ == "3ft"))) +
  tm_polygons(
              title = "Pct. Inundation",
              col = 'value', 
              palette = 'viridis', 
              ...
              id = "hex_id",
              popup.vars = c("Pct. Inundation" = "pct_SLR_")) +
    tm_layout(title = "Three Feet Sea Level Rise")+
  tm_view(view.legend.position = c("right", "bottom",
            colorNA = 'transparent'))
  
seven_ft = tm_shape((piv_long_SLR |> filter (pct_SLR_ == "7ft"))) +
  tm_polygons(
              title = "Pct. Inundation",
              col = 'value', 
              palette = 'viridis', 
              ...
              id = "hex_id",
              popup.vars = c("Pct. Inundation" = "pct_SLR_")) +
    tm_layout(title = "Seven Feet Sea Level Rise")+
  tm_view(view.legend.position = c("right", "bottom"),
            colorNA = 'transparent')
  
tmap_arrange(zero_ft, one_ft, ncol = 2)

tmap_arrange(two_ft, three_ft, seven_ft, ncol = 3)
```
...
tm_shape(phl_ebird_hex_means) +
  tm_polygons(title = "Risk Level",
              ...
              popup.vars = c("Avg. Unique Species" = "avg_unique_species",
                             "% SLR (1ft)" = "pct_SLR_1ft"))+
    tm_layout(title = "Sea Level Rise Risk to Biodiversity")+
    tm_view(view.legend.position = c("right", "bottom"),
            colorNA = 'transparent')
```
